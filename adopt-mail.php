...
<?php 
	...
	$ip = $_SERVER['REMOTE_ADDR'];
			...
			$fullMessage = $fullMessage."sent a Message using Adopt Form";
			$fullMessage = $fullMessage."<br/><br/>";
...
<script type="application/javascript">window.location.href="http://127.0.0.1/FluffyFriendsFinal/public/adopt";</script>
